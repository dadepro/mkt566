...
1. Download the dataset: [**`marketing_eda.csv`**](https://github.com/dadepro/mkt566/raw/main/w2/code/data/marketing_eda.csv) (if it opens in the browser instead of downloading, right-click the link → Save Link As...).
2. Make a new folder for today (for example `variation-case`), put the file in it, and in VS Code choose **File → Open Folder...** to open that folder.

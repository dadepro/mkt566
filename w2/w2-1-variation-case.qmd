...
1. Download the dataset: [**`variation-case-data.zip`**](https://github.com/dadepro/mkt566/raw/main/w2/variation-case-data.zip). Unzip it (double-click; Safari may have unzipped it for you already) to get `marketing_eda.csv`.

# ============================================================================
# MKT 566, Week 2: Simulate the marketing dataset for the variation case
# ============================================================================
# This script GENERATES data/marketing_eda.csv, the dataset used in the
# in-class variation case (w2-1-variation-case.Rmd). The CSV already ships
# in the data folder, so you do NOT need to run this script -- it is here
# so you can see exactly how the data was created (note how the outliers
# and the skewed spend distribution are injected on purpose).
# ============================================================================

...
- Tuesday, Sept. 22:
  ...
  - In-class exercise, the Airbnb case: **[partial-solution handout](https://raw.githack.com/dadepro/mkt566/main/w4/w4-airbnb-case-partial.html)**, with all the code already run and every figure and table displayed. Your job: answer the questions, write the recommendation, and prepare a short presentation of your findings. Answers and slides due Sunday, Sept. 27. Optional, if you want to run it yourself: the [full vibecoding version](https://raw.githack.com/dadepro/mkt566/main/w4/w4-airbnb-case.html) and [data](https://github.com/dadepro/mkt566/raw/main/w4/airbnb-case-data.zip) (600 KB)

...
`ai-log.md` accumulates across chats, but each chat only knows its own conversation. So paste the log prompt (the last step of this handout) **before you close each chat**, or that session's requests are lost.
:::

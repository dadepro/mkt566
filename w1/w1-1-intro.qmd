...
**IDE suggestions:** VS Code (pretty much any programming language, integrates with Codex, Claude, and Copilot), RStudio (R only),
Cursor.
...
3. **An AI coding tool**, whichever you prefer:
   ...
   [GitHub Copilot](https://code.visualstudio.com/docs/copilot/overview), or
   [Cursor](https://cursor.com)

::: {.box}
Never installed a coding tool before? Follow the step-by-step
[**VS Code + AI assistant setup guide**](https://raw.githack.com/dadepro/mkt566/main/w1/vscode-setup.html),
then the [**Running R Code in VS Code guide**](https://raw.githack.com/dadepro/mkt566/main/w1/r-setup.html).
:::
...
or use the point-and-click
[GitHub Desktop app](https://docs.github.com/en/desktop/overview/getting-started-with-github-desktop).

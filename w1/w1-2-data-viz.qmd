...
::: {.smaller-80 .muted}
All four datasets share the same means, variances, correlation
...
(it includes the datasets in `data/`), open the scripts in VS Code, and
...
::: {.smaller-80 .muted}
Alphabetical order is by default; sorted order requires `fct_reorder()` in R.
:::

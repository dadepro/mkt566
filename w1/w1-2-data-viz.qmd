...
<!-- TODO(Davide): export slide 4 of w1-2-data-viz.pptx as images/dv-groupon.png,
     then uncomment this slide (the original figure is an EMF file that browsers
     cannot display).

## An (almost) perfect example

![](images/dv-groupon.png){fig-align="center" width="72%"}

::: {.smaller-80 .muted}
Source: *The Groupon Effect on Yelp Ratings: A Root Cause Analysis*
(Byers, Mitzenmacher, and Zervas 2012)
:::
-->
...
::: {.box}
Download the whole
[`code/` folder](https://github.com/dadepro/mkt566/tree/main/w1/code)
